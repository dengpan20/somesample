...
/**
 * @author Paddy
 * @time 2020-05-31 23:52
 * @class describe
 */
public class DPRuler extends ViewGroup {
    ...
    public DPRuler(Context context) {
        super(context);
        initRuler(context);

    }

    public DPRuler(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public DPRuler(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initRuler(Context context) {
        ...
        switch (mStyle){
            case TOP_HEAD:
                mInnerRuler = new TopHeadDPRuler(context, this);
                paddingHorizontal();
                break;
//            case BOTTOM_HEAD:
...
//                break;
    ...
    private int initCenterStartX() {
        return (int) (centerStartX = (getMeasuredHeight() - getBigScaleLength())/2f);
//        Log.i("TopHead",getMeasuredHeight() +" centerX "+centerStartX);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        if (changed) {
            Log.i("TopHeadOnlayout",getMeasuredHeight() +" centerX "+centerStartX);
            centerStartX = initCenterStartX();
            mInnerRuler.layout(mPaddingLeft, mPaddingTop+(int)centerStartX, r - l - mPaddingRight, b - t - mPaddingBottom+(int) centerStartX);
        }
    }
